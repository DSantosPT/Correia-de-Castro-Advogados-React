...
const Actividade = (props) => {
  return (
    <div className="actividade-container">
      ...
      <div className="actividade-container01 card">
        <div className="actividade-container02 card-content">
          <span className="actividade-text textXL">
            Abaixo pode ver cada uma das áreas de serviço nas quais pode contar
            com a Correia de Castro Advogados
          </span>
          <Servicos rootClassName="servicos-root-class-name"></Servicos>
        </div>
      </div>
      <div className="actividade-container03">
        <div id="contencioso-juridico" className="actividade-container04">
          <ServiceCardLeft
        ...
        <div id="imobiliario-e-arrendamento" className="actividade-container05">
          <ServiceCardRight
        ...
        <div
          ...
          className="actividade-container06"
        >
          <ServiceCardLeft
        ...
        <div id="societario-comercial" className="actividade-container07">
          <ServiceCardRight
        ...
        <div id="familia-menores-sucessoes" className="actividade-container08">
          <ServiceCardLeft
        ...
        <div id="trabalho" className="actividade-container09">
          <ServiceCardRight
            Area="Trabalho"
        ...
        <div id="registos-notariado" className="actividade-container10">
          <ServiceCardLeft
