    ...
    <div className="quemsomos-container">
      ...
      <div className="quemsomos-container01">
        ...
        <div className="quemsomos-container06">
          <h3 className="quemsomos-text text2XL">Jenna Stones</h3>
          <div className="quemsomos-container07">
            <svg viewBox="0 0 1024 1024" className="quemsomos-icon">
              <path d="M512 490q44 0 75-31t31-75-31-75-75-31-75 31-31 75 31 75 75 31zM512 86q124 0 211 87t87 211q0 62-31 142t-75 150-87 131-73 97l-32 34q-12-14-32-37t-72-92-91-134-71-147-32-144q0-124 87-211t211-87z"></path>
            </svg>
            <span className="quemsomos-text1 textSM">
              LOS ANGELES, CALIFORNIA
            </span>
          </div>
          <div className="quemsomos-container08">
            <svg viewBox="0 0 1024 1024" className="quemsomos-icon2">
            ...
            <span className="quemsomos-text2 textSM">
              Solution Manager - Creative Tim Officer
            </span>
          </div>
          <div className="quemsomos-container09">
            <div className="quemsomos-container10">
              <svg
                viewBox="0 0 1097.142857142857 1024"
                className="quemsomos-icon4"
              >
              ...
              <span className="quemsomos-text3 textSM">
                University of Computer Science
              </span>
            </div>
          </div>
          <div className="quemsomos-container11"></div>
          <span className="quemsomos-text4">
            <span className="quemsomos-text5">
          ...
          <span className="quemsomos-text6">
            <span>Show more</span>
            <span></span>
          </span>
        </div>
